...
public class MultiDimension3 {
    public static void main(String[] args) {
        ...
        // The outcomes will be run into an error that will prevent us from further implementations
      ...
      Arrays.sort(citiesOfStates1[0]);
        ...
        // when you see Tampa or Houston say "it must be really hot"
        System.out.println("------------------------");
        ...
        for (String[] state : citiesOfStates1){

            for (String city : state){
                if (city.equalsIgnoreCase("Tampa")||city.equalsIgnoreCase("Houston")){
                    System.out.println("it must be hot over there during summer because you live in >> " + city);
                }else {
                    System.out.println("weather should be fine if you live in >> " + city);
                }
            }
        }
        System.out.println("=============this is for traditional FOR LOOP================");
        for (int i = 0; i < citiesOfStates1.length; i++){

            for (int k = 0; k < citiesOfStates1[i].length; k++){
                System.out.println(citiesOfStates1[i][k]);
                if (citiesOfStates1[i][k].equalsIgnoreCase("Tampa")||citiesOfStates1[i][k].equalsIgnoreCase("Houston")){
                    System.out.println("it must be hot over there during summer because you live in >> " + citiesOfStates1[i][k]);
                }else {
                    System.out.println("weather should be fine if you live in >> " + citiesOfStates1[i][k]);
                }
